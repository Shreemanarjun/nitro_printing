...
EM_JS(int, nitro_web_instance_changed, (), {
    ...
    if (reg["nitro_printing"] === wasmExports) return 0;
    reg["nitro_printing"] = wasmExports;
    return 1;
});
...
void _nitro_release_instance_streams(const void* impl) {
    g_ports_onPrintJobChanged.dropInstance(impl);
    g_ports_onPrinterStatusChanged.dropInstance(impl);
    g_ports_onPrinterDiscovered.dropInstance(impl);
}

void HybridNitroPrinting::emit_onPrintJobChanged(NitroCppBuffer item) {
    auto _ports = g_ports_onPrintJobChanged.snapshot(this);
...
void HybridNitroPrinting::emit_onPrinterStatusChanged(NitroCppBuffer item) {
    auto _ports = g_ports_onPrinterStatusChanged.snapshot(this);
    if (_ports.empty()) { if (item.data) { free((void*)item.data); } return; }
    Dart_CObject obj;
    if (item.data == nullptr) {
        obj.type = Dart_CObject_kNull;
...
void HybridNitroPrinting::emit_onPrinterDiscovered(NitroCppBuffer item) {
    auto _ports = g_ports_onPrinterDiscovered.snapshot(this);
    if (_ports.empty()) { if (item.data) { free((void*)item.data); } return; }
    Dart_CObject obj;
    if (item.data == nullptr) {
        obj.type = Dart_CObject_kNull;
...
static std::unordered_map<int64_t, std::shared_ptr<HybridNitroPrinting>>& _g_instances() {
    static std::unordered_map<int64_t, std::shared_ptr<HybridNitroPrinting>> m;
    return m;
}
...
static HybridNitroPrintingFactory& _g_factory() {
    static HybridNitroPrintingFactory f;
    return f;
}
...
struct alignas(64) _NitroInstSlot {
    ...
    std::atomic<HybridNitroPrinting*> ptr{nullptr};
};
static _NitroInstSlot _g_inst_cache[_kNitroCacheWays];
static HybridNitroPrinting* _nitro_get_instance(int64_t id) {
    ...
    HybridNitroPrinting* p = (it != _g_instances().end()) ? it->second.get() : nullptr;
    if (p) {
...
extern "C" {
void nitro_printing_register_factory(void* fn) {
    _g_factory() = *static_cast<HybridNitroPrintingFactory*>(fn);
}
void nitro_printing_register_impl(HybridNitroPrinting* impl) {
    std::lock_guard<std::mutex> _lk(_g_instances_mtx());
    if (impl) _g_instances()[0] = std::shared_ptr<HybridNitroPrinting>(impl, [](HybridNitroPrinting*){});
    else _g_instances().erase(0);
    _nitro_invalidate_cache();
}
HybridNitroPrinting* nitro_printing_get_impl() {
...
int8_t nitro_printing_is_printing_supported(int64_t instanceId, NitroError* _nitro_err) {
    ...
    if (!_impl) { _nitro_desktop_err(_nitro_err, "NotInitialized", "No C++ implementation registered. Call nitro_printing_register_impl() first."); return false; }
    try {
        return _impl->isPrintingSupported();
...
int64_t nitro_printing_get_printers_count(int64_t instanceId, NitroError* _nitro_err) {
    ...
    if (_nitro_err) { _nitro_err->hasError = 0; }  // S8: clear slot
    auto _impl = _nitro_get_instance(instanceId);
    if (!_impl) { _nitro_desktop_err(_nitro_err, "NotInitialized", "No C++ implementation registered. Call nitro_printing_register_impl() first."); return 0; }
    try {
        return _impl->getPrintersCount();
    } catch (const std::exception& e) {
        _nitro_desktop_err(_nitro_err, "CppException", e.what());
        return 0;
    } catch (...) {
...
const char* nitro_printing_get_printer_driver_version(int64_t instanceId, const char* printerId, NitroError* _nitro_err) {
    ...
    if (_nitro_err) { _nitro_err->hasError = 0; }  // S8: clear slot
    auto _impl = _nitro_get_instance(instanceId);
    if (!_impl) { _nitro_desktop_err(_nitro_err, "NotInitialized", "No C++ implementation registered. Call nitro_printing_register_impl() first."); return nullptr; }
    try {
        std::string _res = _impl->getPrinterDriverVersion(std::string(printerId));
...
void nitro_printing_get_all_printers(int64_t instanceId, NitroError* _nitro_err, int64_t dart_port) {
    ...
    try {
        _impl->getAllPrinters(_nitro_err, dart_port);
    } catch (const std::exception& e) {
        _nitro_desktop_err(_nitro_err, "CppException", e.what());
        Dart_CObject _err = { Dart_CObject_kNull };
        Dart_PostCObject_DL(dart_port, &_err);
...
uint8_t* nitro_printing_get_printer_at(int64_t instanceId, int64_t index) {
    nitro_printing_clear_error();
    auto _impl = _nitro_get_instance(instanceId);
    if (!_impl) { nitro_report_error("NotInitialized", "No C++ implementation registered. Call nitro_printing_register_impl() first.", nullptr, nullptr); return _nitro_desktop_result_err("native error"); }
    try {
        NitroCppBuffer _res = _impl->getPrinterAt(index);
...
uint8_t* nitro_printing_get_default_printer(int64_t instanceId) {
    ...
    if (!_impl) { nitro_report_error("NotInitialized", "No C++ implementation registered. Call nitro_printing_register_impl() first.", nullptr, nullptr); return _nitro_desktop_result_err("native error"); }
    try {
        NitroCppBuffer _res = _impl->getDefaultPrinter();
        uint8_t* _out = (uint8_t*)malloc(_res.size + 1);
        if (!_out) { return nullptr; }
        _out[0] = 0;
        if (_res.size > 0 && _res.data) { memcpy(_out + 1, _res.data, _res.size); }
...
uint8_t* nitro_printing_get_printer_capabilities(int64_t instanceId, const char* printerId) {
    ...
    if (!_impl) { nitro_report_error("NotInitialized", "No C++ implementation registered. Call nitro_printing_register_impl() first.", nullptr, nullptr); return _nitro_desktop_result_err("native error"); }
    try {
        NitroCppBuffer _res = _impl->getPrinterCapabilities(std::string(printerId));
        uint8_t* _out = (uint8_t*)malloc(_res.size + 1);
        if (!_out) { return nullptr; }
        _out[0] = 0;
        if (_res.size > 0 && _res.data) { memcpy(_out + 1, _res.data, _res.size); }
...
void nitro_printing_print_text(int64_t instanceId, const char* text, void* settings, NitroError* _nitro_err, int64_t dart_port) {
    ...
    try {
        _impl->printText(std::string(text), settings == nullptr ? NitroCppBuffer{ nullptr, 0 } : NitroCppBuffer{ (const uint8_t*)settings + 4, (size_t)*(int32_t*)settings }, _nitro_err, dart_port);
    } catch (const std::exception& e) {
        _nitro_desktop_err(_nitro_err, "CppException", e.what());
        Dart_CObject _err = { Dart_CObject_kNull };
        Dart_PostCObject_DL(dart_port, &_err);
...
void nitro_printing_print_image(int64_t instanceId, uint8_t* imageData, size_t imageData_length, void* settings, NitroError* _nitro_err, int64_t dart_port) {
    ...
    try {
        _impl->printImage(imageData, static_cast<size_t>(imageData_length), settings == nullptr ? NitroCppBuffer{ nullptr, 0 } : NitroCppBuffer{ (const uint8_t*)settings + 4, (size_t)*(int32_t*)settings }, _nitro_err, dart_port);
    } catch (const std::exception& e) {
        _nitro_desktop_err(_nitro_err, "CppException", e.what());
        Dart_CObject _err = { Dart_CObject_kNull };
        Dart_PostCObject_DL(dart_port, &_err);
...
void nitro_printing_print_pdf(int64_t instanceId, uint8_t* pdfData, size_t pdfData_length, void* settings, NitroError* _nitro_err, int64_t dart_port) {
    ...
    try {
        _impl->printPdf(pdfData, static_cast<size_t>(pdfData_length), settings == nullptr ? NitroCppBuffer{ nullptr, 0 } : NitroCppBuffer{ (const uint8_t*)settings + 4, (size_t)*(int32_t*)settings }, _nitro_err, dart_port);
    } catch (const std::exception& e) {
        _nitro_desktop_err(_nitro_err, "CppException", e.what());
        Dart_CObject _err = { Dart_CObject_kNull };
        Dart_PostCObject_DL(dart_port, &_err);
...
void nitro_printing_print_document(int64_t instanceId, void* document, void* settings, NitroError* _nitro_err, int64_t dart_port) {
    ...
    try {
        _impl->printDocument(NitroCppBuffer{ (const uint8_t*)document + 4, (size_t)*(int32_t*)document }, settings == nullptr ? NitroCppBuffer{ nullptr, 0 } : NitroCppBuffer{ (const uint8_t*)settings + 4, (size_t)*(int32_t*)settings }, _nitro_err, dart_port);
    } catch (const std::exception& e) {
        _nitro_desktop_err(_nitro_err, "CppException", e.what());
        Dart_CObject _err = { Dart_CObject_kNull };
        Dart_PostCObject_DL(dart_port, &_err);
...
void nitro_printing_print_file(int64_t instanceId, const char* filePath, void* settings, NitroError* _nitro_err, int64_t dart_port) {
    ...
    try {
        _impl->printFile(std::string(filePath), settings == nullptr ? NitroCppBuffer{ nullptr, 0 } : NitroCppBuffer{ (const uint8_t*)settings + 4, (size_t)*(int32_t*)settings }, _nitro_err, dart_port);
    } catch (const std::exception& e) {
        _nitro_desktop_err(_nitro_err, "CppException", e.what());
        Dart_CObject _err = { Dart_CObject_kNull };
        Dart_PostCObject_DL(dart_port, &_err);
...
void nitro_printing_print_batch(int64_t instanceId, void* documents, int8_t stopOnError, void* settings, NitroError* _nitro_err, int64_t dart_port) {
    ...
    try {
        _impl->printBatch(NitroCppBuffer{ (const uint8_t*)documents + 4, (size_t)*(int32_t*)documents }, stopOnError, settings == nullptr ? NitroCppBuffer{ nullptr, 0 } : NitroCppBuffer{ (const uint8_t*)settings + 4, (size_t)*(int32_t*)settings }, _nitro_err, dart_port);
    } catch (const std::exception& e) {
        _nitro_desktop_err(_nitro_err, "CppException", e.what());
        Dart_CObject _err = { Dart_CObject_kNull };
        Dart_PostCObject_DL(dart_port, &_err);
...
void nitro_printing_show_print_dialog(int64_t instanceId, void* document, void* initialSettings, NitroError* _nitro_err, int64_t dart_port) {
    ...
    try {
        _impl->showPrintDialog(NitroCppBuffer{ (const uint8_t*)document + 4, (size_t)*(int32_t*)document }, initialSettings == nullptr ? NitroCppBuffer{ nullptr, 0 } : NitroCppBuffer{ (const uint8_t*)initialSettings + 4, (size_t)*(int32_t*)initialSettings }, _nitro_err, dart_port);
    } catch (const std::exception& e) {
        _nitro_desktop_err(_nitro_err, "CppException", e.what());
        Dart_CObject _err = { Dart_CObject_kNull };
        Dart_PostCObject_DL(dart_port, &_err);
...
void nitro_printing_render_preview(int64_t instanceId, void* document, void* settings, NitroError* _nitro_err, int64_t dart_port) {
    ...
    try {
        _impl->renderPreview(NitroCppBuffer{ (const uint8_t*)document + 4, (size_t)*(int32_t*)document }, settings == nullptr ? NitroCppBuffer{ nullptr, 0 } : NitroCppBuffer{ (const uint8_t*)settings + 4, (size_t)*(int32_t*)settings }, _nitro_err, dart_port);
    } catch (const std::exception& e) {
        _nitro_desktop_err(_nitro_err, "CppException", e.what());
        Dart_CObject _err = { Dart_CObject_kNull };
        Dart_PostCObject_DL(dart_port, &_err);
...
void nitro_printing_get_page_count(int64_t instanceId, void* document, NitroError* _nitro_err, int64_t dart_port) {
    ...
    try {
        _impl->getPageCount(NitroCppBuffer{ (const uint8_t*)document + 4, (size_t)*(int32_t*)document }, _nitro_err, dart_port);
    } catch (const std::exception& e) {
        _nitro_desktop_err(_nitro_err, "CppException", e.what());
        Dart_CObject _err = { Dart_CObject_kNull };
        Dart_PostCObject_DL(dart_port, &_err);
...
void nitro_printing_print_to_file(int64_t instanceId, void* document, const char* outputPath, void* settings, NitroError* _nitro_err, int64_t dart_port) {
    ...
    try {
        _impl->printToFile(NitroCppBuffer{ (const uint8_t*)document + 4, (size_t)*(int32_t*)document }, std::string(outputPath), settings == nullptr ? NitroCppBuffer{ nullptr, 0 } : NitroCppBuffer{ (const uint8_t*)settings + 4, (size_t)*(int32_t*)settings }, _nitro_err, dart_port);
    } catch (const std::exception& e) {
        _nitro_desktop_err(_nitro_err, "CppException", e.what());
        Dart_CObject _err = { Dart_CObject_kNull };
        Dart_PostCObject_DL(dart_port, &_err);
...
void nitro_printing_cancel_print_job(int64_t instanceId, const char* jobId, NitroError* _nitro_err, int64_t dart_port) {
    ...
    try {
        _impl->cancelPrintJob(std::string(jobId), _nitro_err, dart_port);
    } catch (const std::exception& e) {
        _nitro_desktop_err(_nitro_err, "CppException", e.what());
        Dart_CObject _err = { Dart_CObject_kNull };
        Dart_PostCObject_DL(dart_port, &_err);
...
void nitro_printing_pause_print_job(int64_t instanceId, const char* jobId, NitroError* _nitro_err, int64_t dart_port) {
    ...
    try {
        _impl->pausePrintJob(std::string(jobId), _nitro_err, dart_port);
    } catch (const std::exception& e) {
        _nitro_desktop_err(_nitro_err, "CppException", e.what());
        Dart_CObject _err = { Dart_CObject_kNull };
        Dart_PostCObject_DL(dart_port, &_err);
...
void nitro_printing_resume_print_job(int64_t instanceId, const char* jobId, NitroError* _nitro_err, int64_t dart_port) {
    ...
    try {
        _impl->resumePrintJob(std::string(jobId), _nitro_err, dart_port);
    } catch (const std::exception& e) {
        _nitro_desktop_err(_nitro_err, "CppException", e.what());
        Dart_CObject _err = { Dart_CObject_kNull };
        Dart_PostCObject_DL(dart_port, &_err);
...
void nitro_printing_clear_print_queue(int64_t instanceId, NitroError* _nitro_err, int64_t dart_port) {
    ...
    try {
        _impl->clearPrintQueue(_nitro_err, dart_port);
    } catch (const std::exception& e) {
        _nitro_desktop_err(_nitro_err, "CppException", e.what());
        Dart_CObject _err = { Dart_CObject_kNull };
        Dart_PostCObject_DL(dart_port, &_err);
...
void nitro_printing_get_print_jobs_count(int64_t instanceId, NitroError* _nitro_err, int64_t dart_port) {
    ...
    try {
        _impl->getPrintJobsCount(_nitro_err, dart_port);
    } catch (const std::exception& e) {
        _nitro_desktop_err(_nitro_err, "CppException", e.what());
        Dart_CObject _err = { Dart_CObject_kNull };
        Dart_PostCObject_DL(dart_port, &_err);
...
uint8_t* nitro_printing_get_print_job_at(int64_t instanceId, int64_t index) {
    ...
    if (!_impl) { nitro_report_error("NotInitialized", "No C++ implementation registered. Call nitro_printing_register_impl() first.", nullptr, nullptr); return _nitro_desktop_result_err("native error"); }
    try {
        NitroCppBuffer _res = _impl->getPrintJobAt(index);
        uint8_t* _out = (uint8_t*)malloc(_res.size + 1);
        if (!_out) { return nullptr; }
        _out[0] = 0;
        if (_res.size > 0 && _res.data) { memcpy(_out + 1, _res.data, _res.size); }
...
uint8_t* nitro_printing_get_print_job_status(int64_t instanceId, const char* jobId) {
    ...
    if (!_impl) { nitro_report_error("NotInitialized", "No C++ implementation registered. Call nitro_printing_register_impl() first.", nullptr, nullptr); return _nitro_desktop_result_err("native error"); }
    try {
        NitroCppBuffer _res = _impl->getPrintJobStatus(std::string(jobId));
        uint8_t* _out = (uint8_t*)malloc(_res.size + 1);
        if (!_out) { return nullptr; }
        _out[0] = 0;
        if (_res.size > 0 && _res.data) { memcpy(_out + 1, _res.data, _res.size); }
...
void nitro_printing_start_printer_discovery(int64_t instanceId, NitroError* _nitro_err, int64_t dart_port) {
    ...
    try {
        _impl->startPrinterDiscovery(_nitro_err, dart_port);
    } catch (const std::exception& e) {
        _nitro_desktop_err(_nitro_err, "CppException", e.what());
        Dart_CObject _err = { Dart_CObject_kNull };
        Dart_PostCObject_DL(dart_port, &_err);
...
void nitro_printing_stop_printer_discovery(int64_t instanceId, NitroError* _nitro_err, int64_t dart_port) {
    ...
    try {
        _impl->stopPrinterDiscovery(_nitro_err, dart_port);
    } catch (const std::exception& e) {
        _nitro_desktop_err(_nitro_err, "CppException", e.what());
        Dart_CObject _err = { Dart_CObject_kNull };
        Dart_PostCObject_DL(dart_port, &_err);
...
void nitro_printing_test_printer_connection(int64_t instanceId, const char* printerId, const uint8_t* timeoutSeconds, NitroError* _nitro_err, int64_t dart_port) {
    ...
    try {
        _impl->testPrinterConnection(std::string(printerId), (timeoutSeconds == nullptr || timeoutSeconds[0] == 0) ? std::optional<int64_t>(std::nullopt) : std::make_optional(*reinterpret_cast<const int64_t*>(timeoutSeconds + 1)), _nitro_err, dart_port);
    } catch (const std::exception& e) {
        _nitro_desktop_err(_nitro_err, "CppException", e.what());
        Dart_CObject _err = { Dart_CObject_kNull };
        Dart_PostCObject_DL(dart_port, &_err);
...
void nitro_printing_set_default_printer(int64_t instanceId, const char* printerId, NitroError* _nitro_err, int64_t dart_port) {
    ...
    try {
        _impl->setDefaultPrinter(std::string(printerId), _nitro_err, dart_port);
    } catch (const std::exception& e) {
        _nitro_desktop_err(_nitro_err, "CppException", e.what());
        Dart_CObject _err = { Dart_CObject_kNull };
        Dart_PostCObject_DL(dart_port, &_err);
...
void nitro_printing_open_system_print_queue(int64_t instanceId, const char* printerId, NitroError* _nitro_err, int64_t dart_port) {
    ...
    try {
        _impl->openSystemPrintQueue(std::string(printerId), _nitro_err, dart_port);
    } catch (const std::exception& e) {
        _nitro_desktop_err(_nitro_err, "CppException", e.what());
        Dart_CObject _err = { Dart_CObject_kNull };
        Dart_PostCObject_DL(dart_port, &_err);
...
void nitro_printing_open_printer_properties(int64_t instanceId, const char* printerId, NitroError* _nitro_err, int64_t dart_port) {
    ...
    try {
        _impl->openPrinterProperties(std::string(printerId), _nitro_err, dart_port);
    } catch (const std::exception& e) {
        _nitro_desktop_err(_nitro_err, "CppException", e.what());
        Dart_CObject _err = { Dart_CObject_kNull };
        Dart_PostCObject_DL(dart_port, &_err);
...
void nitro_printing_print_raw(int64_t instanceId, uint8_t* data, size_t data_length, void* settings, NitroError* _nitro_err, int64_t dart_port) {
    ...
    try {
        _impl->printRaw(data, static_cast<size_t>(data_length), settings == nullptr ? NitroCppBuffer{ nullptr, 0 } : NitroCppBuffer{ (const uint8_t*)settings + 4, (size_t)*(int32_t*)settings }, _nitro_err, dart_port);
    } catch (const std::exception& e) {
        _nitro_desktop_err(_nitro_err, "CppException", e.what());
        Dart_CObject _err = { Dart_CObject_kNull };
        Dart_PostCObject_DL(dart_port, &_err);
...
void nitro_printing_print_esc_pos(int64_t instanceId, uint8_t* escPosData, size_t escPosData_length, void* settings, NitroError* _nitro_err, int64_t dart_port) {
    ...
    try {
        _impl->printEscPos(escPosData, static_cast<size_t>(escPosData_length), settings == nullptr ? NitroCppBuffer{ nullptr, 0 } : NitroCppBuffer{ (const uint8_t*)settings + 4, (size_t)*(int32_t*)settings }, _nitro_err, dart_port);
    } catch (const std::exception& e) {
        _nitro_desktop_err(_nitro_err, "CppException", e.what());
        Dart_CObject _err = { Dart_CObject_kNull };
        Dart_PostCObject_DL(dart_port, &_err);
...
void nitro_printing_print_zpl(int64_t instanceId, const char* zpl, void* settings, NitroError* _nitro_err, int64_t dart_port) {
    ...
    try {
        _impl->printZpl(std::string(zpl), settings == nullptr ? NitroCppBuffer{ nullptr, 0 } : NitroCppBuffer{ (const uint8_t*)settings + 4, (size_t)*(int32_t*)settings }, _nitro_err, dart_port);
    } catch (const std::exception& e) {
        _nitro_desktop_err(_nitro_err, "CppException", e.what());
        Dart_CObject _err = { Dart_CObject_kNull };
        Dart_PostCObject_DL(dart_port, &_err);
...
void nitro_printing_cancel_raw_print(int64_t instanceId, NitroError* _nitro_err, int64_t dart_port) {
    ...
    try {
        _impl->cancelRawPrint(_nitro_err, dart_port);
    } catch (const std::exception& e) {
        _nitro_desktop_err(_nitro_err, "CppException", e.what());
        Dart_CObject _err = { Dart_CObject_kNull };
        Dart_PostCObject_DL(dart_port, &_err);
...
uint8_t* nitro_printing_get_printer_status_detail(int64_t instanceId, const char* printerId, const uint8_t* timeoutSeconds) {
    ...
    try {
        ...
        NitroCppBuffer _res = _impl->getPrinterStatusDetail(std::string(printerId), _opt_timeoutSeconds);
        uint8_t* _out = (uint8_t*)malloc(_res.size + 1);
        if (!_out) { return nullptr; }
        _out[0] = 0;
        if (_res.size > 0 && _res.data) { memcpy(_out + 1, _res.data, _res.size); }
...
void nitro_printing_register_on_print_job_changed_stream(int64_t instanceId, int64_t dart_port) {
    g_ports_onPrintJobChanged.add(_nitro_get_instance(instanceId), dart_port);
}
void nitro_printing_release_on_print_job_changed_stream(int64_t dart_port) {
...
void nitro_printing_register_on_printer_status_changed_stream(int64_t instanceId, int64_t dart_port) {
    g_ports_onPrinterStatusChanged.add(_nitro_get_instance(instanceId), dart_port);
}
void nitro_printing_release_on_printer_status_changed_stream(int64_t dart_port) {
...
void nitro_printing_register_on_printer_discovered_stream(int64_t instanceId, int64_t dart_port) {
    g_ports_onPrinterDiscovered.add(_nitro_get_instance(instanceId), dart_port);
}
void nitro_printing_release_on_printer_discovered_stream(int64_t dart_port) {
