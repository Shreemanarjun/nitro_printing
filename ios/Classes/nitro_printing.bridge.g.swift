...
public func _nitro_printing_call_getPrinterStatusDetail(_ printerId: UnsafePointer<CChar>?, _ timeoutSeconds: UnsafeMutableRawPointer?) -> UnsafeMutablePointer<UInt8>? {
    ...
    var _nitroErr: Error? = nil
    Task.detached {
        do { _nitroOk = try await impl.getPrinterStatusDetail(printerId: printerIdStr, timeoutSeconds: NitroNullableInt.fromNative(timeoutSeconds!.assumingMemoryBound(to: UInt8.self)).nullable) }
        catch { _nitroErr = error }
        sema.signal()
    }
    sema.wait()
