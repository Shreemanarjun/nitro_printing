...
abstract class PrinterRepository {
  ...
  Future<p.PrintResult> printDocument(
    p.PrintDocument doc, {
  ...
  Future<p.PrintResult> printEscPos(
  ...
  Future<p.PreviewResult> renderPreview(
    p.PrintDocument doc, {
    p.PrintSettings? settings,
  });
...
class NitroPrinterRepository implements PrinterRepository {
  ...
  @override
  Future<bool> isPrintingSupported() => Future.value(_i.isPrintingSupported());
  @override
  Future<int> getPrintersCount() => Future.value(_i.getPrintersCount());
  @override
  Future<List<p.PrinterInfo>> getAllPrinters() =>
  ...
  @override
  Future<p.PrintResult> printImage(
    Uint8List data, {
    p.PrintSettings? settings,
  ...
  @override
  Future<bool> cancelRawPrint() => _i.cancelRawPrint();
  ...
  @override
  Future<int> getPageCount(p.PrintDocument doc) => _i.getPageCount(doc);
  @override
  Future<bool> printToFile(
    p.PrintDocument doc,
    String outputPath, {
  ...
  @override
  Future<bool> cancelPrintJob(String jobId) => _i.cancelPrintJob(jobId);
  @override
  Future<bool> pausePrintJob(String jobId) => _i.pausePrintJob(jobId);
  @override
  Future<bool> resumePrintJob(String jobId) => _i.resumePrintJob(jobId);
  @override
  Future<bool> clearPrintQueue() => _i.clearPrintQueue();
  @override
  ...
  @override
  Future<bool> startPrinterDiscovery() => _i.startPrinterDiscovery();
  @override
  Future<bool> stopPrinterDiscovery() => _i.stopPrinterDiscovery();
  ...
  @override
  Stream<p.PrintJobUpdate> onPrintJobChanged() => _i.onPrintJobChanged();
  @override
  Stream<p.PrinterStatus> onPrinterStatusChanged() =>
      _i.onPrinterStatusChanged();
  @override
  Stream<p.DiscoveredPrinter> onPrinterDiscovered() => _i.onPrinterDiscovered();
}
